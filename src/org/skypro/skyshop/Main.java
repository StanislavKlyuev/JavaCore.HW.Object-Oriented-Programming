...
ЗАДАЧА  5. ООП: Java Collections Framework: List
        ...
        1. Изменение используемой структуры данных в классе ProductBacket
            •	Поменяйте используемую структуру данных в классе ProductBacket с массива на список. Тип списка выберите самостоятельно. Учитывайте, что мы не обращаемся к элементам корзины по индексам, а только добавляем и удаляем элементы, не используя их индексы.
